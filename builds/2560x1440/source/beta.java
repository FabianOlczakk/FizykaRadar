...
public void setup() 
{
  ...
  String portName = showInputDialog("Podaj nazwę portu:\n").toUpperCase();
...
public void serialEvent (Serial port) 
{
  ...
  radarAngle = PApplet.parseInt(serialAngle);
  radarDistance = PApplet.parseInt(serialDistance);
}
  public void settings() {  size (2560, 1440);  smooth(); }
